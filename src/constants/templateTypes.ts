...
export const COMPONENT_CATEGORIES: Record<ComponentCategory, { displayName: string; icon: string }> = {
  'content-presentation': { displayName: 'Content Presentation', icon: 'layers' },
  ...
  'accessibility':        { displayName: 'Accessibility & Support', icon: 'universal-access' },
...
export const COMPONENT_TYPE_CATEGORY: Record<ComponentTypeId, ComponentCategory> = {
  // Content Presentation
