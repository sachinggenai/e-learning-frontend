...
export const COURSE_COMPLETION_SAMPLE: CourseCompletionResponse = {
  ...
  pages: [
    ...
    },
    {
      ...
      components: [
        {
          componentId: "c1-02-01",
          completed: true,
          completionType: "interact",
        },
        {
...
export const INTERACTION_EVENTS: InteractionEvent[] = [
  ...
  },
  {
    ...
    data: { interactionId: "tab-chemical", value: "Chemical Hazards" },
    completed: true,
  },
  {
    pageId: "p1-02",
    componentId: "c1-02-02",
    interactionType: "click",
    data: { interactionId: "hs-1", value: "Wet Floor" },
    completed: false,
  },
  {
    pageId: "p1-02",
    componentId: "c1-02-02",
    interactionType: "click",
    data: { interactionId: "hs-2", value: "Unsecured Shelf" },
    completed: false,
  },
  {
    pageId: "p1-02",
    componentId: "c1-02-02",
    interactionType: "click",
    data: { interactionId: "hs-3", value: "Blocked Exit" },
    completed: false,
  },
  {
    pageId: "p1-02",
    componentId: "c1-02-02",
    interactionType: "click",
    data: { interactionId: "hs-4", value: "Frayed Wire" },
    completed: true,
  },
  {
    pageId: "p1-04",
  ...
  },
  {
    pageId: "p1-02",
    componentId: "c1-02-01",
    interactionType: "audio-play",
    data: { interactionId: "audio-hazards", duration: 120 },
    completed: false,
  },
  {
    pageId: "p1-02",
    componentId: "c1-02-01",
    interactionType: "audio-complete",
    data: { interactionId: "audio-hazards", duration: 120 },
    completed: true,
  },
  {
    pageId: "p2-02",
    componentId: "c2-02-02",
    interactionType: "click",
    data: { interactionId: "fc-1" },
    completed: false,
  },
  {
    pageId: "p2-03",
    ...
    data: {
      interactionId: "opt-1a",
      value: "Respond calmly",
      score: 10,
      maxScore: 10,
      isCorrect: true,
    },
  ...
  },
  {
    ...
    interactionType: "select",
    data: {
      interactionId: "opt-2a",
      value: "Show empathy & resolve",
      score: 10,
      maxScore: 10,
      isCorrect: true,
    },
  ...
  {
    pageId: "p3-02",
    componentId: "c3-02-01",
    interactionType: "navigation",
    data: { interactionId: "sl-3", value: "Document Structure" },
    completed: false,
  },
  {
    pageId: "p3-04",
...
export const AUDIO_ASSETS: AudioAssetResponse[] = [
  {
    ...
    transcript:
      "In this section we cover the four main types of workplace hazards: physical, chemical, ergonomic, and biological...",
    mimeType: "audio/mpeg",
    fileSize: 1920000,
    courseId: "course-safety-101",
  ...
  },
  {
    ...
    transcript:
      "Personal Protective Equipment, or PPE, is your last line of defense against workplace hazards...",
    mimeType: "audio/mpeg",
    fileSize: 1440000,
    courseId: "course-safety-101",
  ...
  },
  {
    ...
    transcript:
      "Welcome to the Customer Service Excellence course. Great customer service builds loyalty...",
    mimeType: "audio/mpeg",
    fileSize: 960000,
...
export const VALIDATION_FAIL: CourseValidationResponse = {
  ...
  errors: [
    {
      field: "pages[2].components[0].data.question",
      message: "Question text is required for MCQ component.",
    },
    {
      field: "pages[4].components[1].data.pairs",
      message: "Matching component requires at least 2 pairs.",
    },
    {
      field: "scoring.config.passingScore",
      message: "Passing score must be between 0 and 100.",
    },
    {
      field: "pages[5].pageCompletion.requiredComponents",
      message: 'Cannot reference non-existent component ID "c-missing".',
    },
  ],
};
...
export const MEDIA_UPLOADS: MediaUploadResponse[] = [
  ...
  {
    fileId: "media-002",
    filePath: "/uploads/images/customer-service.jpg",
    fileUrl: "https://images.unsplash.com/photo-1556745757-8d76bdb6984b?w=800",
  ...
  {
    fileId: "media-003",
    filePath: "/uploads/images/webdev-coding.jpg",
    fileUrl:
      "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=800",
    fileName: "webdev-coding.jpg",
    mimeType: "image/jpeg",
    fileSize: 312000,
    category: "image",
  },
  {
    fileId: "media-004",
    filePath: "/uploads/audio/hazards-overview.mp3",
    fileUrl: "/audio/hazards-overview.mp3",
    fileName: "hazards-overview.mp3",
    mimeType: "audio/mpeg",
    fileSize: 1920000,
    category: "audio",
  },
  {
    fileId: "media-005",
    filePath: "/uploads/documents/html-cheatsheet.pdf",
    fileUrl: "/downloads/html-cheatsheet.pdf",
