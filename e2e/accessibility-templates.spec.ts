...
test.describe('Accessibility templates', () => {
  test('Accessibility Tip Card appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Accessibility Tip Card');
  });

  test('Keyboard Navigation Guide appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Keyboard Navigation Guide');
  });

  test('Screen Reader Guide appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Screen Reader Guide');
  });

  test('Language Selector appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Language Selector');
  });

  test('Transcript / Caption Page appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Transcript / Caption Page');
  });
});
