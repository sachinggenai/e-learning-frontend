...
test.describe('Gamification templates', () => {
  test('Quiz Game appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Quiz Game');
  });

  test('Points and Badges appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Points and Badges');
  });

  test('Progress Tracker appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Progress Tracker');
  });

  test('Level-Based Learning appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Level-Based Learning');
  });
});
