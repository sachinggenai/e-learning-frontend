...
test.describe('Microlearning templates', () => {
  test('Microlearning Cards appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Microlearning Cards');
  });

  test('Flashcards appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Flashcards');
  });

  test('Quick Tips appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Quick Tips');
  });
});
