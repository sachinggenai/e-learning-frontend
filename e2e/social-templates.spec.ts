...
test.describe('Social templates', () => {
  test('Discussion Prompt appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Discussion Prompt');
  });

  test('Peer Review appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Peer Review');
  });

  test('Poll / Vote appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Poll / Vote');
  });

  test('Team Challenge appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Team Challenge');
  });

  test('Scenario Debate appears in the component picker', async ({ page }) => {
    await loadExampleCourse(page);
    await expectComponentVisibleInPicker(page, 'Scenario Debate');
  });
});
